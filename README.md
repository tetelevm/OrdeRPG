...
In general, the project is divided into 2 parts - the `framework` directory and
everything else.

`framework` is kind of my personal library for the future, the rest of the
project is a browser-based rpg game (though, rather, only its backend).
