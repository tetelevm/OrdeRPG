...
class FuncTest(TestCase):
    ...
    def test_generate_random_string(self):
        ...
        string = generate_random_string(100)
        self.assertTrue(set(string).issubset(default_alphabet))
    ...
    def test_generate_random_advanced_string(self):
        ...
        string = generate_random_advanced_string(100)
        self.assertTrue(set(string).issubset(advanced_alphabet))
